# templates_transaction.py
"""Transaction page HTML templates."""
...
# Parent transaction group template
...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 text-gray-800 min-h-screen">
  <div class="max-w-6xl mx-auto p-4 lg:p-6">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl p-6 mb-6">
